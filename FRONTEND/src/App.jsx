...
function App() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8">
          ...
          <form
            onSubmit={addTodo}
            className="flex items-center gap-3 shadow-sm border border-gray-200 p-3 rounded-lg"
          >
            <input
